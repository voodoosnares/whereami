$(document).ready(function () {
    ...
    function endGame() {
        ...
        $('#endGame').html('<h1>Čestitamo!</h1><h2>Vaš rezultat je:</h2><h1>'
            + totalScore + '!</h1><br/><p>Šeruj ovo na:</p><br/><div class="btn btn-large facebook fb-share-button" data-href="https://www.facebook.com/sharer/sharer.php?src=100&p[title]=' + encodeURIComponent('Whereami') + '&p[summary]=' + encodeURIComponent('Upravo sam osvojio ' + totalScore + ' poena u igri PRONAĐI SE U BEOGRADU!') + '&p[url]=' + encodeURIComponent('http://aries.rs') + '" target="_blank" data-width="54" data-type="box_count"><i class="fa fa-facebook fa-lg"></i><span>Facebook</span></div> <a class="btn btn-large twitter" href="https://twitter.com/intent/tweet?text=Upravo+sam+osvojio+' + totalScore + '+poena+u+igri+PRONAĐI+SE+U+BEOGRADU+@AriesCTW%21&url=http://www.fun.aries.rs/whoami" target="_blank"><i class="fa fa-twitter fa-lg"></i><span class="rps-text">Twitter</span></a></p><br/><button class="btn btn-large btn-success playAgain" type="button">Igraj ponovo?</button>');
        $('#endGame').fadeIn(500);
        rminitialize();
